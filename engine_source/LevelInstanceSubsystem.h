...
public:
	...
	ALevelInstance* CommitLevelInstance(ALevelInstance* LevelInstanceActor, bool bDiscardEdits = false, bool bPromptForSave = true, TSet<UPackage*>* DirtyPackages = nullptr);
